...
OUT="/home/claude/out/THE BRAIN BRAKE V3.pdf"
...
c.drawString(ML,y,"Version three. The comic strip. Shooting and animation document.")
y-=38
...
# ============================================================ 3 WHAT CHANGED
y=head("What changed from version two","FOR KRISTIJAN AND VENKATESH")
items=[("The format","Fifty composite shots became a moving comic strip. Characters speak in bubbles "
...
# ============================================================ END
y=H/2+30
c.setFont('MB',8); c.setFillColor(ACC); c.drawCentredString(W/2,y+34,"END CARD")
c.setFont('DB',18); c.setFillColor(INK)
c.drawCentredString(W/2,y,"THE LIMIT IS A SETTING, NOT A WALL.")
foot(); c.showPage(); c.save()
print("written",OUT,os.path.getsize(OUT),"pages",pg[0],"runtime",tc(TOTAL/FPS))
