...
OUT = "/home/claude/out/HOW TO ACT NATURALLY v3 - Manan.pdf"
...
def foot(label=""):
    ...
    c.drawString(ML,28,"HOW TO ACT NATURALLY  ·  version three  ·  Manan Periwal")
...
for i, L in enumerate(LINES):
    ...
    for ln in wrap(text,'DB',size,CW):
        c.drawString(ML,y,ln); y-=size*1.30
    y-=16
