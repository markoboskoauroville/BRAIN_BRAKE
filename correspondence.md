# CORRESPONDENCE — THE BRAIN BRAKE

Every message to and from the crew lives here, so that any chat can pick up a conversation without
Marko repeating himself. **Started 9.8.2026.** Earlier messages were reconstructed from previous chat
sessions and are marked with how confident that reconstruction is.

**Rule for whoever is writing next.** When you draft a message, paste it into section 5 with the date,
the recipient and a status of DRAFT. When Marko confirms it went out, change the status to SENT. When a
reply comes back, log the substance of it. A message that is not in this file did not happen.

---

## 1. WHO GETS WHAT LANGUAGE AND TONE

| Person | Language | Tone | Channel |
|---|---|---|---|
| **Neha Sonthalia Periwal** | English | Lowercase, warm, plain. She is the client and the only approval point. Never technical. | Email and WhatsApp |
| **Manan Periwal** | English | Through Neha for anything commercial. Direct only about the work, and short. He is 14 and has ADHD. | Via Neha |
| **Venkatesh Aurovenkatesh** | English | Practical and specific. He wants setups, not intent. +91 81488 97033 | WhatsApp |
| **Kristijan Kaurić** | **Croatian** | Peer to peer, direct, money spoken about plainly. Twenty years in the business, he does not need selling to. | WhatsApp and email |

There is a **WhatsApp production group** with Venkatesh, Kristijan and Marko, Coach Brain as the group
image.

---

## 2. THE COMMERCIAL FACTS, SO THEY ARE NEVER MISQUOTED

**Marko.** 1200 EUR total: 700 concept, direction and edit, 200 sound mix, 300 original score. Terms
50/50. 600 EUR advance received 3.8. Balance on delivery.

**Kristijan.** Quoted 250 EUR per day, estimating 3 to 5 days, so 750 to 1250 EUR. He agreed to work
below his normal rate because it is a student film and he liked the idea. **Not yet approved by Neha.**
He invoices Marko, Marko puts the invoice in a shared folder for Neha to collect. Half before he starts
animating, half on delivery. No advance, no start.

**Venkatesh.** Quotes Neha directly, paid locally in rupees, so only the European fees cross a border.

**Marko's bank.** Erste&Steiermärkische Bank d.d., Rijeka. IBAN HR4924020063206388466, SWIFT ESBCHR22.
OIB 76414630904. Kučićki put 1a, 51000 Rijeka. Mantra Productions.

Marko's phone in international form: **+385 97 6790768**.

---

## 3. DATES EVERYBODY HAS BEEN GIVEN

    Shoot                18.8.        confirmed
    Animation back       27.8.        as quoted to Kristijan
    Film essentially cut end of 8. mjesec
    Internal delivery    1.9.
    Competition deadline 15.9.

**Warning about older drafts.** Messages written before 9.8.2026 say the shoot is 15. and 16.8. and that
the film has eight scenes. Both are now wrong. It is **18.8.** and **nine scenes**. Do not resend any
old draft without correcting these two things.

---

## 4. WHAT HAS ALREADY GONE OUT

Reconstructed from earlier chats. Confidence noted honestly.

**To Neha, early 8. mjesec, SENT, high confidence.** Response to Manan's first script. Told her the
script runs four to five minutes rather than two, that scene 2 explained the old theory twice and one
version should go, that the low power mode scene was the best idea in the script and should be
protected, that the phone should be generic and Hill and Noakes drawn rather than photographed for
rights, and that Manan's own lines should stay short because that suits how he will be shot. Gave her
Marko's number for the transfer. Introduced Kristijan and brojka.hr. Asked for three or four days to
break the script down. Ended by asking her to tell Manan he is impressed.

**To Neha, 8. mjesec, SENT.** Invoice, and the 600 EUR advance was received 3.8.

**To Neha, 8. mjesec, SENT.** Both outlines as matched PDFs in identical design, version one being
Manan's original and version two being Marko's development, so the comparison would be fair.

**To Venkatesh, 8. mjesec, SENT.** Initial WhatsApp brief. He is standing by.

**To the WhatsApp group, around 8.8., DRAFTED and believed sent.** Introduced Venkatesh and Kristijan to
each other, described the film, promised both documents on 10.8., asked for honesty about what is
feasible straight away rather than politely later. **This draft carries the old 15. and 16.8. shoot
dates and eight scenes.** If it went out, the correction below needs to go to the group.

**To Kristijan, a Croatian message with budget transparency, DRAFTED in an earlier chat, NOT SENT.**
Superseded. Use the draft in section 5 instead.

---

## 5. READY TO SEND

### 5.1 TO KRISTIJAN, CROATIAN, NOT YET SENT

The message that is actually outstanding. It brings him up to date, gives him the real dates, tells him
where his hours matter, and is honest that the budget is not yet approved.

```
Bok Kristijane,

Evo gdje smo, da ne čekaš u prazno.

Film je narastao na devet scena, ali je i dalje točno dvije minute. Sve je crtano grafitnom olovkom na toplom kremastom papiru. Manan je jedina prava fotografija u cijelom filmu, ubačen u taj crtani svijet. Taj kontrast je cijela vizualna ideja i to je ono što treba čuvati.

Snimanje je 18.8. u Pondicherryju. Manan pred sivim platnom, nekoliko postava, svijet dolazi poslije.

Animatorski brief ti stiže sa shot listom, referentnim listovima za likove i lokacije, i jednom rečenicom namjere po kadru. Neću ti raditi po stilu, stil je tvoj. Dobivaš točne upute što se događa u kadru i zašto.

Gdje je težina. Druga scena je najvažnijih osam sekundi u filmu i tu ide najviše sati. Vrijeme ide unatrag, kamera kruži oko glave trkača, kapljice se vraćaju u kožu. To je scena koja mora biti savršena i za nju sam ti već napisao cijeli opis kadra jer ga crtež ne može pokazati.

Isporuka. ProRes 4444 s alpha kanalom, 25fps, 4K, zasebni layeri gdje grafika ide preko snimke. Nazivi scena_broj_opis_v1.mov. Rok 27.8. natrag kod mene. Ako ti to djeluje pretijesno, reci odmah, rok natjecanja je 15.9. pa imamo prostora.

Novac. Ostajemo na 250 eura po danu, procjena tri do pet dana. Da budem korektan, naručiteljica to još nije odobrila, pa nemoj ništa planirati dok ti ne javim da je potvrđeno. Račun šalješ meni, ja ga stavljam u zajedničku mapu odakle ga ona preuzima. Pola unaprijed prije nego kreneš, pola po predaji.

Javi mi samo je li ti termin izvediv i imaš li kakvo pitanje prije nego ti pošaljem papire.

Marko
```

### 5.2 TO THE WHATSAPP GROUP, ENGLISH, IF THE OLD MESSAGE WENT OUT

Two corrections only. Short, because a correction that arrives with an explanation reads as an excuse.

```
Two corrections to what I sent.

The shoot is Saturday 18 August, one day. Please ignore the 15 and 16 in my earlier message.

And the film is now nine scenes rather than eight. Same two minutes, same idea, one scene split in two because it was doing two jobs at once. Nothing you have been told about your own work changes.

Documents still land here first.
```

### 5.3 TO NEHA, ENGLISH, WHEN THE ANIMATION BUDGET NEEDS APPROVING

Lowercase, plain, no pressure, and it gives her the number she has to say yes or no to.

```
hi neha,

one thing that needs your yes before it can move.

kristijan, our animator in zagreb, quoted 250 euro a day and estimates three to five days, so somewhere between 750 and 1250 euro for the animation. that is well under his normal rate, he agreed to it because it is a student film and he liked the idea.

he invoices me, i put the invoice in the shared folder and you collect it from there. half before he starts, half on delivery. that is standard here and he will not start without it.

i have not asked him to plan anything until you confirm, so nothing is committed. just tell me yes or a number you would rather work with and i will handle the rest.
...
## 6. THINGS TO REMEMBER WHEN WRITING TO EACH OF THEM

**Neha.** She is a journalist and reads fast. Lead with the decision she has to make. Never send her a
technical problem, only a choice. She has an outstanding decision on the animation budget.

**Kristijan.** Tell him where the hours matter and let him own the style. He responds to being treated
as a peer who is doing a favour, which he is. Money plainly, no softening.

**Venkatesh.** He wants the work order, not the reasoning. Setups, framing, eyelines, wardrobe, running
order. If something cannot be lit or framed as written, he needs to be invited to say so on paper
...
**The documents that go with them, all in `assets/pdf/`:**
    ...
    5 - v5 shooting guide - Manan and Neha.pdf          Every frame, the line, how it is shot.
    6 - v5 camera guide - Venkatesh.pdf                 Format, lenses, light, six fixed points.
