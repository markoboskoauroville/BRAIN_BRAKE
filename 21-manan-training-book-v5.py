...
OUT = "/home/claude/out/HOW TO ACT NATURALLY v5 - Manan.pdf"
...
def foot(label=""):
    ...
    c.drawString(ML,28,"HOW TO ACT NATURALLY  ·  version five  ·  Manan Periwal")
...
for i, L in enumerate(LINES):
    ...
    bh = PAD + len(body)*size*1.30 + PAD*0.7
    top = y
